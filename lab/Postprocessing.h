...
public:
	...
	void Update(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
...
private:
	...
	void createDownsamplingRTT(int width, int height, ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	void processTexture(
	...
	const float eyeAdaptationS = 0.30f;
